...
public class YoMommaSoFatJokesSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(YoMommaSoFatJokesSpeechlet.class);
		private static ArrayList<String> usedJokesList = new ArrayList<>();
    ...
    public SpeechletResponse onIntent(final IntentRequest request, final Session session)
        ...
        if("InitialYoMommaSoFatJokesIntent".equals(intentName)) {
            return initialYoMommaSoFatJokesRequest(intent);
    ...
    private SpeechletResponse initialYoMommaSoFatJokesRequest(Intent intent) {
        String speechOutput = this.getRandomJoke();
        String repromptText = this.getRandomJoke();
    ...
    private SpeechletResponse getAmazonHelpResponse() {
        String speechOutput = "Ask a Yo Momma joke, by saying \"Yo Momma\"";
        String repromptText = "Again, Ask a Yo Momma joke, by saying \"Yo Momma\"";
        return askForResponse(speechOutput, false, repromptText, false);
    }
    ...
    private PlainTextOutputSpeech getGoodByeText() {
		...
		private String getRandomJoke() {
			String joke = FAT_JOKES[getRandomIndex()];
			if(!usedJokesList.contains(joke)){
				usedJokesList.add(joke);
			} else {
				joke = getRandomJoke();
			}
			return joke;
		...
		private int getRandomIndex(){
			return new Random().nextInt(FAT_JOKES.length);
		}


		private static final String[] FAT_JOKES = {
				...
				"Yo mama so fat, she can devour a Big Mac in two bites.  ",
				"yo mama so fat, her Apple Watch is and iPad Pro on a rope.  ",
				...
				"Yo mama is so fat the police use her as a road blocker. ",
				...
				"Yo mama so fat, when she bends over, helicopters think her butt's a landing pad ",
				...
				"yo mama so fat when she went to heaven she didn't get a mansion she goat a 24 hour mcdonalds. ",
				...
				"Yo mama so hungry when she goes to the petting zoo she brings barbecue sauce. ",
				...
				"Yo mama so fat that she woke up on all four sides of the bed! ",
				...
				"Yo mama so fat when she wears light blue people yell \"Tsunami\". ",
				...
				"Yo mama so fat that every buffet in the world has her picture on the window with a Big X on it. ",
				"Yo mama so fat she started flashing people and got arrested for trafficking. ",
				...
				"Yo mama so fat she went in a bed store, and ask for a waterbed, the owner put a blanket over the Pacific Ocean ",
				...
				"yo mama so fat her ass needed 5 zipcodes ",
				...
				"Yo mama's so fat that her part time job is being a tug boat! ",
				"Yo mama so fat that when God sent her to heaven she fell down to hell. ",
				"Yo momma so fat that her senior picture had to be taken from space. ",
				...
				"Yo mamma so ridiculous she is ridiculously fat. ",
				"Yo mama so fat she wears the eqautor for a belt just to hold up her pants. ",
				"Yo mama so fat that her nickname is Fatty McButterpants. ",
				...
				"Yo mama so fat that her feet need license plates. ",
				...
				"Yo mama's so fat, she has to fly cargo class. ",
				...
				"Yo momma so fat her favorite children's book is \"Three Little Pigs in a Blanket\" ",
				...
				"Yo Mama is so fat her high school photo was a double page spread. ",
				...
				"yo mama so fat her strechmarks got strechmarks! ",
				"yo mama's so fat that when she wore a red shirt, people said hey look koolaid! ",
				"Yo mom is so fat that she walked into a tattoo parlor and the worker said \"Wooaahh! We don't paint murals!\" ",
				"Yo mama so fat when she walked past the t.v.you missed three episodes. ",
				...
				"Yo Mamas so fat she has three pockets on the back of her jeans. ",
				...
				"Yo mama so fat, when's she walk down the street, she creates potholes. ",
				...
				"Yo mama is so fat that when she had fish and chips she used her belly button as a salt cellar. ",
				"Yo mama so fat, wine companies stand in line waiting for her to shit so they can buy it and harvest their Vineyards. ",
				...
				"yo momma so large, she doesn't need a data plan, she's already world wide. ",
				"yo momma so fat at McDonalds she looked at the menu and said okay ",
				...
				"Yo mamas so fat she doesn't need two others to make a crowd. ",
				...
				"Yo mommas so fat after she gave birth it took the doctors a year to find you. ",
				...
				"Your mamma so fat she calls the apple orchard a fruit salad. ",
				"Yo momma so fat people at the carnival said \"How many tickets to ride that blimp?\" ",
				"Your mama so fat that when you where born they couldn't find..... You ",
				"Yo mom is so large when she gets on a elevator it always goes to the ground floor. ",
				...
				"Yo momma so fat, her village got 1000 cattle as a dowry, when they gave her to cannibals. ",
				...
				"Yo moma so fat, they call her belly the low rider. ",
				...
				"Yo mama so fat, when she went to Japan in a green bikini, everyone screamed,\"GODZILLA!!\" ",
				"Yo mama so fat she went to the store and tryed to go down one isle and took up two! ",
				"Yo mama so fat, when she bent down, the Grand Canyon got jealous ",
				"yo mama so fat every time she turns around they give her a welcome back party. ",
				"Yo momma so fat if she lived on Pluto, scientists would call it a planet again. ",
				...
				"Yo mamma so fat, she uses the local car wash to take a shower. ",
				...
				"Yo mama so fat an 18 wheeler could fit in her ass crack. ",
				"yo mama so fat she sat on a bear and turned it into rug ",
				"Yo mama so fat the FDA took her to a grocery store to look for organic food items. ",
				...
				"Yo mamma so fat the abandoned ship said \"Land ho.\" ",
				...
				"Yo mama like the baconater. Big, greasy, and meaty. ",
				"Yo momma so FREAKING fat she uses motorcycles as rollerblade's ",
				"Yo mum so fat, a picture of her weighs more than I do. ",
				"Yo mama so fat, she has to take selfies in parts ",
				"Yo momma so fat, when she was in space, scientists thought her neck was pluto. ",
				"Yo mama so fat I asked her what her favorite animal was, and she said the ones I can eat. "
		};
